...
6. [[phase-6-plan]]: multi-aircraft (n>2) — 6a ✅ (MVP-sum/VO-union + FleetMemory), 6b ✅ (run_fleet), MVP `_BIAS_EPS` head-on fix ✅; 6d ✅ (scenario builders + combined demo/observation); 6e (IPR sweep) + 6f (comm) pending. Priority coordination → future-features.
