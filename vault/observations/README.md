...
31 notes so far, with their figures in `img/`.
...
ideas at #14–16, for instance), the number points into that retired source, not into anything in
this repo. Those particular ideas are the v0.5 research goal in `docs/roadmap.md`, and have not
been built.
